"""Regression test for the decision/disclosure/payment/origination-service
host-port bypass.
...
none of the four are ever re-published to the host.
"""
import pytest
...
@pytest.mark.parametrize(
    "service_name",
    ["decision-service", "disclosure-service", "payment-service", "origination-service"],
)
